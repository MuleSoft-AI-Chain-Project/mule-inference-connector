...
public class GeminiTextGenerationConnection extends TextGenerationConnection {
  ...
  public GeminiTextGenerationConnection(HttpClient httpClient, ObjectMapper objectMapper,
