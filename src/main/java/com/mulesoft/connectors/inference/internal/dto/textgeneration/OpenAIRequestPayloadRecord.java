...
public record OpenAIRequestPayloadRecord(String model,List<ChatPayloadRecord>messages,Number maxCompletionTokens,Number temperature,Number topP,List<FunctionDefinitionRecord>tools,
